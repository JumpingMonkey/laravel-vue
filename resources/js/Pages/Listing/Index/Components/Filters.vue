<template>
    <form @submit.prevent="filter">
        <div class="mb-8 mt-4 flex flex-wrap gap-2">
            ...
            <div class="flex flex-nowrap items-center">
                <input class="input-filter-l w-28" v-model="filterForm.areaFrom" type="text" placeholder="Area from"/>
                <input class="input-filter-r w-28" v-model="filterForm.areaTo" type="text" placeholder="Area to"/>
            </div>
